...
#define SPECIES_MEGA_RAICHU_X (SPECIES_MEGA_START + 48)
#define SPECIES_MEGA_VICTREEBEL (SPECIES_MEGA_START + 49)
#define SPECIES_MEGA_FERALIGATR (SPECIES_MEGA_START + 50)
#define SPECIES_MEGA_SKARMORY (SPECIES_MEGA_START + 51)
#define SPECIES_MEGA_STARAPTOR (SPECIES_MEGA_START + 52)
#define SPECIES_MEGA_SCOLIPEDE (SPECIES_MEGA_START + 53)
#define SPECIES_MEGA_CHANDELURE (SPECIES_MEGA_START + 54)
#define SPECIES_MEGA_CHESNAUGHT (SPECIES_MEGA_START + 55)
#define SPECIES_MEGA_DELPHOX (SPECIES_MEGA_START + 56)
#define SPECIES_MEGA_GRENINJA (SPECIES_MEGA_START + 57)
#define SPECIES_MEGA_PYROAR (SPECIES_MEGA_START + 58)
#define SPECIES_MEGA_DRAGALGE (SPECIES_MEGA_START + 59)
#define SPECIES_MEGA_HAWLUCHA (SPECIES_MEGA_START + 60)
#define SPECIES_MEGA_FALINKS (SPECIES_MEGA_START + 61)
#define SPECIES_MEGA_GLIMMORA (SPECIES_MEGA_START + 62)

#define MAX_MEGA_NUM (SPECIES_MEGA_GLIMMORA)
